...
`id`  bigint(20) unsigned  NOT NULL AUTO_INCREMENT COMMENT '活动编号' ,
...
alter table t_esp_banner_info  modify column banner_type varchar(20) not null default '' comment 'banner类型';

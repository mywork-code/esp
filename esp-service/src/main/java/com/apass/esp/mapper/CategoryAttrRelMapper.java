...
public interface CategoryAttrRelMapper extends GenericMapper<CategoryAttrRel, Long> {
    ...
    List<CategoryAttrRel> selectCategoryAttrRelByQueryEntity(CategoryAttrRelQuery categoryAttrRelQuery);

    int deleteCategoryAttrRel(CategoryAttrRel categoryAttrRel);
}

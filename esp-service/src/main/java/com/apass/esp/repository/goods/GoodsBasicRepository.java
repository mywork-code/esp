...
public class GoodsBasicRepository extends BaseMybatisRepository<GoodsBasicInfoEntity, Long> {
	...
	public List<GoodsBasicInfoEntity> selectGoodsBySkuIdOrGoodsCode(GoodsBasicInfoEntity param){
    	return getSqlSession().selectList("selectGoodsBySkuIdOrGoodsCode", param);
    }
    ...
    public Integer selectJDGoodsCount(){
    	return getSqlSession().selectOne("selectJDGoodsCount");
    }
	/**
     * 搜索商品(新品，默认)
     */

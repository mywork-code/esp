...
public class AfterSaleService {
    ...
    public void returnGoods(String requestId, String userId, String orderId, BigDecimal returnPriceVal,
            String operate, String reason, String content, List<GoodsStockIdNumDto> returngoodsList,
        ...
        if ("jd".equals(orderInfo.getSource())) {
            ...
            asPickwareDto.setPickwareVillage(StringUtils.isEmpty(addressInfoEntity.getTownsCode()) ? 0
                    : Integer.valueOf(addressInfoEntity.getTownsCode()));
            ...
            asReturnwareDto.setReturnwareVillage(StringUtils.isEmpty(addressInfoEntity.getTownsCode()) ? 0
                    : Integer.valueOf(addressInfoEntity.getTownsCode()));
            asReturnwareDto.setReturnwareAddress(addressInfoEntity.getAddress());
            ...
            for (GoodsStockIdNumDto goodsStockIdNumDto : returngoodsList) {
                OrderDetailInfoEntity orderDetailInfoEntity = resultMap.get(goodsStockIdNumDto
                        .getGoodsStockId());
                ...
                if (jdApiResponse.isSuccess()) {// 支持售后
                    ...
                    for (int i = 0; i < JDReturnType.values().length; i++) {
                        if (asPickwareDto.getPickwareType() == JDReturnType.values()[i].getCode()) {
     ...
     */
    public OrderInfoEntity orderRufundValidate(String requestId, Long userId, String orderId,
            OrderInfoEntity orderInfo) throws BusinessException {
     ...
     */
    @Transactional(rollbackFor = Exception.class)
    public void insertServiceProcessInfo(Long refundId, String nodeName, String nodeMessage)
            throws BusinessException {
     ...
     */
    @Transactional(rollbackFor = { Exception.class })
    public void submitLogisticsInfo(String requestId, String userId, String refundId, String orderId,
            String logisticsName, String logisticsNo) throws BusinessException {
     ...
     * @throws BusinessException
     */
    public Map<String, Object> viewProgress(String requestId, String userId, String orderId)
            throws BusinessException {
        ...
        if (!"jd".equalsIgnoreCase(orderInfo.getSource())) {
             ...
             */
            MerchantInfoEntity merchantInfo = memChantRepository.queryByMerchantCode(orderInfo
                    .getMerchantCode());
            ...
            if (refundInfo.getRefundType().equals("1") && RefundStatus.showRlogistics(refundInfo.getStatus())) {
                serviceProcessDto.setRlogisticsName(dataDicRepository.queryDataNameByDataNo(refundInfo
                        .getRlogisticsName()));
        ...
        for (ServiceProcessEntity spe : serviceProcessList) {
            ...
            case "RS01":
                ...
                serviceProcessDto.setRs01TimeStr(DateFormatUtil.dateToString(serviceProcessDto.getRs01Time(),
                        DateFormatUtil.YYYY_MM_DD_HH_MM));

                break;
            case "RS02":
                serviceProcessDto.setRs02Time(spe.getCreateDate());
                serviceProcessDto.setRs02TimeStr(DateFormatUtil.dateToString(serviceProcessDto.getRs02Time(),
                        DateFormatUtil.YYYY_MM_DD_HH_MM));

                break;
            case "RS03":
                serviceProcessDto.setRs03Time(spe.getCreateDate());
                serviceProcessDto.setRs03TimeStr(DateFormatUtil.dateToString(serviceProcessDto.getRs03Time(),
                        DateFormatUtil.YYYY_MM_DD_HH_MM));

                break;
            case "RS04":
                serviceProcessDto.setRs04Time(spe.getCreateDate());
                serviceProcessDto.setRs04TimeStr(DateFormatUtil.dateToString(serviceProcessDto.getRs04Time(),
                        DateFormatUtil.YYYY_MM_DD_HH_MM));

                break;
            case "RS05":
                serviceProcessDto.setRs05Time(spe.getCreateDate());
                serviceProcessDto.setRs05TimeStr(DateFormatUtil.dateToString(serviceProcessDto.getRs05Time(),
                        DateFormatUtil.YYYY_MM_DD_HH_MM));

                break;
            case "RS06":
                serviceProcessDto.setRs06Time(spe.getCreateDate());
                serviceProcessDto.setRs06TimeStr(DateFormatUtil.dateToString(serviceProcessDto.getRs06Time(),
                        DateFormatUtil.YYYY_MM_DD_HH_MM));
        ...
        for (RefundDetailInfoEntity refundDetailInfo : refundDetailInfoList) {
            ...
            OrderDetailInfoEntity orderDetailInfo = orderDetailInfoRepository.select(refundDetailInfo
                    .getOrderDetailId());
     ...
     */
    @Transactional(rollbackFor = Exception.class)
    public void uploadReturnImage(String requestId, String userId, String orderId, String returnImage)
            throws BusinessException {
     ...
     */
    @Transactional(rollbackFor = Exception.class)
    public void uploadReturnImageAsend(String requestId, String userId, String orderId,
            List<String> returnImage) throws BusinessException {

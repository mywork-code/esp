 ...
 */
@Service
public class ProCouponTaskService {
    private static final Logger LOGGER = LoggerFactory.getLogger(ProCouponTaskService.class);
    @Value("${email.address}")
    ...
    public void senProcouponEmai() throws Exception {
        ...
        String[] reciveArr = {"sunchaohai@apass.cn"};

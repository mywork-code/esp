	...
	exports.default = {
	    ...
	    computed: {
	        commisonValue: function commisonValue() {
	            console.log('this.$store.state.commApply.message: ', this.$store.state.commApply.message
	        ...
	        servicecharge: function servicecharge() {
	            ...
	            var minServiceCharge = 20000 * 0.02;
	            if (this.$store.state.commApply.message * 0.02 <= minServiceCharge) {
	                return minServiceCharge;
	            } else {
	                return this.$store.state.commApply.message * 0.02;
	            }
	        },
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    staticClass: ["cancash"]
	  }, [_vm._v("可分期佣金" + _vm._s(this.$store.state.commApply.availableAmount))]), (_vm.isShowArrow) ? _c('ccImage', {
	    staticClass: ["bankcardrightarrow"],
	    attrs: {
	      "src": 'WXLocal/wx_arrow'
	    }
...
/***/ (function(module, exports) {
	...
	module.exports = {
	  ...
	  "content-showKeyBorad": {
	    "marginBottom": 500
	  },
	  "content-hideKeyBorad": {
	    "marginBottom": 150
	  },
	  "wrapper": {
	    "backgroundColor": "#f4f4f4"
	            ...
	            if (this.isClick) {
	                ...
	                that.$store.dispatch('COMMISSION_SAVE_COMMISSIONINFO', {
	                    imgFile: 'JIJJI', callback: function callback() {
	                        ...
	                        if (this.$getConfig().localData.status == '501') {
	                            this.$getConfig().localData.status = '';
	                        }
	                    }
	                });
	            }
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    class: ['content' + (_vm.isShowKeyBorad ? '-showKeyBorad' : '-hideKeyBorad')]
	  }, [_c('div', {
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  ...
	  }, [_vm._v(_vm._s(_vm.starhour) + ":00-" + _vm._s(_vm.endhour) + ":00提交的申请，预计" + _vm._s(_vm.remainingtime) + "分钟后可查看结果，如" + _vm._s(_vm.remainingtime) + "分钟后无结果反馈，可拨打客服电话。")])]) : (_vm.auditStatus == -1 || _vm.auditStatus == -2) ? _c('div', {

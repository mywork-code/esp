...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _MobileAuth = __webpack_require__(266);
	...
	exports.default = {
	    ...
	    methods: {
	        clickReflash: function clickReflash() {
	            ...
	            this.$store.dispatch('IDENTITY_INIT');
	        },
	    ...
	    computed: {
	        ...
	        resultStatus: function resultStatus() {
	            if (this.$store.state.auth.status == '02') {
	                ...
	                if (this.$store.state.auth.page == '301') {
	                    return '0301'; // 激活锁单, 取creditRejRemainDate
	                } else if (this.$store.state.auth.page == '06' || this.$store.state.auth.page == '01') {
	                    return '0302'; // 提现与无额度锁单, 取lockDays
	                }
	        ...
	        contentType: function contentType() {
	            if (this.resultStatus == '0201' || this.resultStatus == '0301' || this.resultStatus == '0302') {
	                return 'fail';
	            } else {
	                return 'wait';
	            }
	        ...
	        isClick: function isClick() {
	            if (this.resultStatus == '0301' || this.resultStatus == '0303') {
	                return false;
	            } else {
	                return true;
	            }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    created: function created() {},
	    mounted: function mounted() {
	        var mobile = this.$getConfig().localData.mobile;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _MobileAuthActions = __webpack_require__(267);

	var mutations = _interopRequireWildcard(_MobileAuthActions);

	var _MobileAuthMutations = __webpack_require__(268);

	var actions = _interopRequireWildcard(_MobileAuthMutations);

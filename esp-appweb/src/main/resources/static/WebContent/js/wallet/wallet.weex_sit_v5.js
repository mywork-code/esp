...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    style: {
	      height: this.$store.state.env.scale == 3 ? 330 : 300
	    }
	  }) : _vm._e(), _c('ccButton', {
	    staticClass: ["btn-commit"],
	    attrs: {
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    staticClass: ["text"]
	  }, [_vm._v(_vm._s(_vm.isCreditCard ? '返回借记卡认证' : '若无借记卡，请点击 '))])])], 1), _c('div', [(this.$store.state.os == 'iOS') ? _c('div', {
	    style: {
	                            ...
	                            if (that.isAgainVerifyCode) {} else {
	                                ...
	                                eventModule.phoneAuthDialog(tempMobile, function (e) {
	                                    ...
	                                    if (e.result == 'verifyCode') {
	                                        ...
	                                        // 重新获取验证码
	                                        //                                        that.$store.dispatch('PHONE_SUBMITINFORMATION', {callback: function (res) {
	                                        that.$store.dispatch('PHONE_COMPARINGINFORMATION', { callback: function callback(res) {
	                                                that.callback(res);
	                                            } }
	                                        //                                        }})

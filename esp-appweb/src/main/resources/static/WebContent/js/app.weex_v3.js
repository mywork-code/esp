...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _index7 = __webpack_require__(193);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = new _vueRouter2.default({
	    ...
	    // 申请额度-子页面
	    { path: '/personalInfoProtocal', component: _personalInfoProtocal2.default }, { path: '/bankList', component: _bankList2.default },
	    ...
	    // 提现
	    { path: '/cashimmediately', component: _cashimmediately2.default }, { path: '/bankcardlist', component: _bankcardlist2.default }, { path: '/cardbinding', component: _cardbinding2.default }, { path: '/withdrawalstate', component: _withdrawalstate2.default },
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _ccImage = __webpack_require__(29);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _ccLine = __webpack_require__(45);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    methods: {
	        ...
	        pushAliPage: function pushAliPage() {
	            console.log('pushAliPage:');
	        },
	        pushMobileAuthPage: function pushMobileAuthPage() {
	            console.log('pushMobileAuthPage:', this.$store.state.auth.mobileAuthFlag);

	            var that = this;
	            if (this.authStatus == '未认证') {
	                // 取值
	                globalEvent.addEventListener('WXAuth', function (r) {
	                    // 根据 r.event 区分事件
	        ...
	        openTradeCard: function openTradeCard() {
	            var content = {
	                title: "请选择您的工作所属行业",
	                items: ["批发/零售/贸易", "通讯/IT/软件", "房地产/建筑", "住宿/餐饮", "文化/体育/娱乐", "运输/仓储/邮政", "制造业", "水/电/燃气业", "水利/环境管理", "采矿/农林牧渔", "金融", "教育", "科研/技术服务", "政府机关/卫生/社会组织", "其他"]
	            };

	            var that = this;
	            eventModule.wxSelectListView(content, this.selectTrade, function (e) {
	                console.log('selectTrade:', e);
	                that.$store.state.auth.industry = e.result;
	            });
	        },
	        ...
	        openSocialCard: function openSocialCard() {
	            ...
	            var that = this;
	            eventModule.wxSelectListView(content, this.selectSocial, function (e) {
	                console.log('selectSocial:', e);
	                that.$store.state.auth.payFundOrSecurity = e.result == '是' ? '1' : '0';
	            });
	        },
	        onCheckYes: function onCheckYes() {
	            this.$store.state.auth.payFundOrSecurity = '1';
	        },
	        onCheckNo: function onCheckNo() {
	            this.$store.state.auth.payFundOrSecurity = '0';
	        },
	        inputSalary: function inputSalary(e) {
	            console.log('inputCard:', e.value);
	            this.$store.state.auth.monthlyIncomeCard = Number(e.value);
	        },
	        inputCash: function inputCash(e) {
	            console.log('inputCash:', e.value);
	            this.$store.state.auth.monthlyIncomeCash = Number(e.value);
	        }
	    },
	    computed: {
	        isClick: function isClick() {
	            if (this.authStatus !== '未认证' && this.$store.state.auth.monthlyIncomeCard !== '' && this.$store.state.auth.monthlyIncomeCash !== '' && this.$store.state.auth.industry !== '' && this.$store.state.auth.profession !== '' && this.$store.state.auth.payFundOrSecurity !== '') {
	                return true;
	            } else {
	                return false;
	            }
	        ...
	        authStatus: function authStatus() {
	            //                wait / fail / null (Reviewing) / noauth
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    attrs: {
	      "types": 'btn',
	      "title": '手机认证',
	      "flag": this.authStatus == '未认证' ? '-mobileAuthNo' : '-mobileAuthYes',
	      "placeholder": _vm.authStatus,
	      "isLineShow": false,
	    ...
	    attrs: {
	      "types": 'inputMoney',
	      "title": '月收入(工资)',
	      "inputValue": this.$store.state.auth.monthlyIncomeCard,
	      "placeholder": '',
	      "maxLength": 10,
	    ...
	    attrs: {
	      "types": 'inputMoney',
	      "title": '月收入(奖金)',
	      "inputValue": this.$store.state.auth.monthlyIncomeCash,
	      "placeholder": '',
	      "maxLength": 10,
	    ...
	    attrs: {
	      ...
	      "title": '所属行业',
	      "placeholder": '请选择',
	      "selectValue": this.$store.state.auth.industry,
	    ...
	    attrs: {
	      ...
	      "title": '职业',
	      "placeholder": '请选择',
	      "selectValue": this.$store.state.auth.profession,
	    ...
	    attrs: {
	      "types": 'checkBox',
	      "title": '是否缴纳公积金或社保',
	      "isCheckRes": this.$store.state.auth.payFundOrSecurity,
	      "onCheckYes": _vm.onCheckYes,
	      "onCheckNo": _vm.onCheckNo
	    }
	  }), _c('infoCell', {
	    attrs: {
	      "types": 'btn',
	      "title": '芝麻分认证',
	      "flag": _vm.isAliAuth == true ? '-aliAuth' : '',
	      "placeholder": '认证芝麻分最高可拿4万额度哦',
	      "onClick": _vm.pushAliPage
	    }
	  }), _c('ccButton', {
	    staticClass: ["btn-commit"],
	    attrs: {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _uiButton = __webpack_require__(78);

	var _uiButton2 = _interopRequireDefault(_uiButton);

	var _grayButton = __webpack_require__(82);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _linkInfo = __webpack_require__(90);
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  ...
	  }) : (_vm.state == '1' || _vm.state == '4') ? _c('text', {
	    staticClass: ["stage_text_sub"]
	  }, [_vm._v("中原地产佣金分期最高额度")]) : _c('text', {
	    staticClass: ["stage_text_sub"]
	  }, [_vm._v("中原地产佣金分期可用额度")]), (_vm.state == '-1') ? _c('text', {
	    staticClass: ["stage_text_sum"]
	  }, [_vm._v(_vm._s(_vm._f("thousandSeparator")(0)))]) : (_vm.state == '1' || _vm.state == '4') ? _c('text', {
	    staticClass: ["stage_text_sum"]
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _ccChose = __webpack_require__(102);
	...
	exports.default = {
	    ...
	    methods: {
	        info_init: function info_init() {
	            ...
	            that.$store.dispatch('PROVID_INFO_INIT', { callback: function callback(res) {
	                    that.formSet = res;
	        ...
	        vercode_init: function vercode_init() {
	            ...
	            var that = this;
	            that.regImg = '';
	            that.$store.dispatch('PROVID_VERIFICODE', { callback: function callback(res) {
	    ...
	    filters: {
	        identityFormat: function identityFormat(e) {
	            return e.substr(0, 6) + '********' + e.substr(12, 6);
	        }
	    },
	    destroyed: function destroyed() {}
	};
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  ...
	  }, [_vm._v(_vm._s(this.$store.state.commsWL.realName))]), _c('text', {
	    staticClass: ["form_list_input"]
	...
	exports.default = {
	    ...
	    methods: {
	        info_init: function info_init() {
	            //不同城市 需输入选项不一样
	            var that = this;
	            that.$store.dispatch('SECURITY_INFO_INIT', { callback: function callback(res) {
	                    that.formSet = res;
	                    that.loadShowBtn = true;
	                } });
	            eventModule.getBaseInfo(function (res) {
	        ...
	        vercode_init: function vercode_init() {
	            ...
	            var that = this;
	            that.regImg = '';
	            that.$store.dispatch('SECURITY_VERIFICODE', { callback: function callback(res) {
	                    that.regImg = 'WXBase64/' + res.vercode;
	                    that.$store.state.commsWL.token = res.token;
	                    that.$store.state.commsWL.base64 = 'WXBase64/' + res.vercode;
	                } });
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _commissioninfor = __webpack_require__(122);
	...
	var _bankcardheader = __webpack_require__(126);

	var _bankcardheader2 = _interopRequireDefault(_bankcardheader);

	var _changenumberframe = __webpack_require__(130);
	...
	exports.default = {
	    ...
	    methods: {
	        subtractnumber: function subtractnumber() {
	            ...
	            // this.$store.state.commApply.platformRecommendedFee = this.$store.state.commApply.message*0.02;
	        },
	        ...
	        commission: function commission() {
	            ...
	            if (this.isbystages) {
	                ...
	                this.$store.dispatch('COMMISSION_COMMCASH_SAVESTREAM', { callback: function callback() {
	                        Vue.NaviHelper.push('native/main/scan', {
	                            title: '额度申请',
	                            showTab: false,
	                            scanTitle: "扫码付佣金",
	                        ...
	                        if (that.$store.state.env.platform == 'iOS') {} else {
	                            Vue.NaviHelper.push('pop');
	                        }
	                    } });
	            }
	        ...
	        changebank: function changebank() {
	            ...
	            Vue.NaviHelper.push('native/main/bankcard', { cardNo: this.$store.state.commApply.cardNo, capital: this.$store.state.commApply.totalAmount }, 'channel_pushChangeBankcard', function (r) {});
	        },
	        ...
	        onChange: function onChange(e) {
	            ...
	            this.$store.state.commApply.platformRecommendedFee = this.$store.state.commApply.message * 0.02;
	            //                 if(this.$store.state.commApply.message.length>10) {
	            //                    // this.$store.state.commApply.message=20000;
	            //                   Vue.TipHelper.showHub('1','最低分期金额20000')
	            //                 }
	            // Vue.TipHelper.showHub('1','最小20000')
	        },
	    ...
	    computed: {
	        commisonValue: function commisonValue() {
	            ...
	            if (Number(this.$store.state.commApply.message) + 100 >= maxValue) {
	    ...
	    mounted: function mounted() {
	        ...
	        this.$store.dispatch('COMMISSION_COMMCASH_INITDATA');
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  ...
	  }, [_vm._v("(最低分期金额20000)")])]) : _vm._e(), (this.types === 'warmprompt') ? _c('div', {
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    staticClass: ["cancash"]
	  }, [_vm._v("可分期佣金" + _vm._s(this.$store.state.commApply.availableAmount))]), _c('ccImage', {
	    staticClass: ["bankcardrightarrow"],
	    attrs: {
	      "src": 'WXLocal/wx_arrow'
	    }
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    attrs: {
	      "types": 'closingcost',
	      "servicecharge": this.$store.state.commApply.platformRecommendedFee
	    }
	  }), _c('commissioninfor', {
	    attrs: {
	      "types": 'warmprompt'
	    }
	  }), (_vm.isbystages) ? _c('infoCell', {
	    attrs: {
	      "types": 'text',
	      "isLineShow": false,
	      "title": '6期共计',
	      "isShowStar": false,
	      "textValue": this.$store.state.commApply.amountAll,
	      "textColor": '#303030'
	    }
	  }) : _vm._e(), (_vm.isbystages) ? _c('infoCell', {
	    attrs: {
	      "types": 'text',
	      "title": '还款日期',
	      "isShowStar": false,
	  ...
	  }, [_vm._v(_vm._s(this.$store.state.commApply.eachPeriodTotalAmount))]), _c('ccImage', {
	    staticClass: ["arrow-explain"],
	    attrs: {
	      "src": 'WXLocal/wx_explain'
	    }
	  })], 1)]), _vm._m(1)]) : _vm._e()], 1), _c('div', [(_vm.isbystages) ? _c('agreeBtn', {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _textareamoudle = __webpack_require__(150);

	var _textareamoudle2 = _interopRequireDefault(_textareamoudle);

	var _ccInput = __webpack_require__(154);
	...
	exports.default = {
	    ...
	    methods: {
	        numberfix: function numberfix() {
	            // this.practicalnumber=Number(this.practicalnumber).toFixed(2);
	            // this.mapStyle.backgroundColor="#e2262a";

	            console.log(this.$store.state.commApply.comsAmt);
	            var num;
	            if (this.$store.state.commApply.comsAmt != '') {
	                num = Number(this.$store.state.commApply.comsAmt).toFixed(2).toString().split(".");
	                num[0] = num[0].replace(new RegExp('(\\d)(?=(\\d{3})+$)', 'ig'), "$1,");
	                //                  this.$store.state.commApply.comsAmt= num.join(".");
	            }
	        },
	        ...
	        submlitinfor: function submlitinfor() {
	            if (this.isClick) {
	                ...
	                if (this.$store.state.debug) {
	                    console.log('111111111111111', this.$store.state.commApply);
	                }

	                var that = this;
	                that.$store.dispatch('COMMISSION_SAVE_COMMISSIONINFO', { imgFile: 'JIJJI', callback: function callback() {

	                        Vue.NaviHelper.push('weex/common?router_waitreview', { title: '等待审核' }, '', function (r) {});
	                        if (that.$store.state.env.platform == 'iOS') {} else {
	                            Vue.NaviHelper.push('pop');
	                        }
	                    } });
	        ...
	        uploadimg: function uploadimg() {
	            var that = this;
	            // this.uploadedicon='WXLocal/wx_camera_light';
	            eventModule.openCameraCallback(function (e) {
	                console.log(e.result);
	                // that.isupload=true;
	                // that.uploadedicon="WXLocal/wx_camera_light";
	        ...
	        uploadconfirm: function uploadconfirm() {
	            ...
	            eventModule.openCameraCallback(function (e) {
	                console.log(e.result);
	                // that.isupload=true;
	                // that.uploadconfirmicon="WXLocal/wx_camera_light";
	        ...
	        comsAmt: function comsAmt(e) {
	            ...
	            this.$store.state.commApply.comsAmt = e.value;
	        }
	    ...
	    computed: {
	        isClick: function isClick() {
	            ...
	            if (this.$store.state.commApply.comsAmt && this.$store.state.commApply.houseHoldAddress && this.area != '请选择地区' && this.$store.state.commApply.isUpload && this.$store.state.commApply.isUploadconfirm) {
	                ...
	                // this.mapStyle.backgroundColor="#c5c5c5";
	                return false;
	            }
	        },
	        workphone: function workphone() {
	            return this.$store.state.commApply.workPhone;
	        },
	        comsAmtmodel: function comsAmtmodel() {
	            return this.comsAmt;
	        }
	    ...
	    mounted: function mounted() {
	        ...
	        this.$store.dispatch('COMMISSION_INIT_COMMISSIONINFO');
	    }
	};
	...
	exports.default = {
	    ...
	    watch: {
	        inputValue: function inputValue(newV, oldV) {
	            ...
	            this.rows = parseInt(newV.length / singleRowLength) + 1;
	        }
	    },
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    attrs: {
	      "src": this.$store.state.commApply.isUpload ? 'WXLocal/wx_camera_light' : 'WXLocal/wx_camera_dark',
	    ...
	    staticClass: ["uploadedicon"],
	    attrs: {
	      "src": this.$store.state.commApply.isUploadconfirm ? 'WXLocal/wx_camera_light' : 'WXLocal/wx_camera_dark',
	    ...
	    attrs: {
	      ...
	      "maxlength": "10",
	      "value": (_vm.comsAmtmodel)
	    },
	    on: {
	      "blur": _vm.numberfix,
	      "input": [function($event) {
	        _vm.comsAmtmodel = $event.target.attr.value
	      }, _vm.comsAmt]
	    }
	  })])]), _c('div', {
	    staticClass: ["address"]
	    ...
	    attrs: {
	      ...
	      "placeholder": '输入填写常用通讯地址，具体至门牌号 (300字以内)',
	      "maxLength": 120,
	    ...
	    attrs: {
	      ...
	      "placeholder": '输入工作单位地址，具体至门牌号 (300字以内)',
	      "maxLength": 120,
	      "onInput": _vm.workAddress
	    }
	  }), _vm._m(2), _c('div', {
	    staticClass: ["worknumber"]
	  }, [_c('input', {
	    staticClass: ["worknumberinput"],
	    attrs: {
	      "type": "tel",
	      "maxlength": "15",
	    ...
	    on: {
	      "input": [function($event) {
	        _vm.workphone = $event.target.attr.value
	      }, _vm.workPhone]
	    }
	  })]), _vm._m(3), _c('ccInput', {
	    staticClass: ["autoInput"],
	    attrs: {
	      ...
	      "placeholder": '输入工作单位名称 (100字以内)',
	      "maxLength": 120,
	      "onInput": _vm.workName
	    }
	  }), _vm._m(4)], 1), _c('div', [_c('ccButton', {
	    staticClass: ["btn"],
	    attrs: {
	      "title": '确认提交',
	...
	exports.default = {
	    ...
	    methods: {
	        refreshonce: function refreshonce() {
	            ...
	            that.$store.dispatch('COMMISSION_REFRESH_COMSSION', { callback: function callback(r) {
	                    if (that.$store.state.debug) {
	                    ...
	                    if (that.auditStatus == 2) {
	                        Vue.NaviHelper.render('cashimmediately', { title: '申请分期' }, '', function (r) {});
	                    }
	                } });
	        },
	        reapplay: function reapplay() {
	            Vue.NaviHelper.render('commissioninformation', { title: '佣金信息' }, '', function (r) {});
	        }

	    },
	    created: function created() {},
	    mounted: function mounted() {
	        var status = this.$getConfig().localData.status;

	        if (status == 501) {
	            this.$store.state.commApply.auditStatus = '-1';
	            this.$store.state.commApply.lockDays = 0;
	        }
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  ...
	  }, [_vm._v(_vm._s(_vm.starhour) + ":00-" + _vm._s(_vm.endhour) + ":00提交的申请，预计" + _vm._s(_vm.remainingtime) + "分钟后可查看结果，")]), _c('text', {
	    staticClass: ["thirdline"]
	  }, [_vm._v("如" + _vm._s(_vm.remainingtime) + "分钟后无结果反馈，可拨打客服电话。")])]) : (_vm.auditStatus == -1 || _vm.auditStatus == -2) ? _c('div', {
	    staticClass: ["applyfail"]
	  }, [_c('text', {
	    staticClass: ["firstline"]
	  }, [_vm._v("佣金分期申请失效")]), _c('text', {
	    staticClass: ["secondline"]
	  }, [_vm._v("根据您的实际情况，安家趣花暂时无法提供")]), _c('text', {
	    staticClass: ["thirdline"]
	  }, [_vm._v("佣金分期服务。")])]) : _vm._e(), (_vm.auditStatus == 1) ? _c('div', {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _mutations = __webpack_require__(169);
	...
	var _getters = __webpack_require__(171);

	var getters = _interopRequireWildcard(_getters);

	var _Wallet = __webpack_require__(172);
	...
	var _Face = __webpack_require__(178);

	var _Face2 = _interopRequireDefault(_Face);

	var _LinkMan = __webpack_require__(181);

	var _LinkMan2 = _interopRequireDefault(_LinkMan);

	var _Commission = __webpack_require__(184);

	var _Commission2 = _interopRequireDefault(_Commission);

	var _commissionApply = __webpack_require__(187);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _WalletMutations = __webpack_require__(173);

	var mutations = _interopRequireWildcard(_WalletMutations);

	var _WalletActions = __webpack_require__(174);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _AuthMutations = __webpack_require__(176);

	var mutations = _interopRequireWildcard(_AuthMutations);

	var _AuthActions = __webpack_require__(177);
...
/***/ (function(module, exports) {
	...
	// 身份认证 - 初始化
	function IDENTITY_INIT(_ref, payload) {
	    var commit = _ref.commit,
	        state = _ref.state,
	        rootState = _ref.rootState;
	    ...
	    Vue.HttpHelper.post(Vue.UrlMacro.IDENTITY_INIT, prama, function (res) {
	        ...
	        if (res.status == 1) {
	            ...
	            if (state.auth.status == '00') {
	                firstStep();
	            } else if (state.auth.status == '01') {
	                if (state.auth.mobileAuthStatus == 0 || state.auth.mobileAuthStatus == null || state.auth.mobileAuthStatus == '') {
	                    seconedStep();
	                } else {
	                    thirdStep();
	                }
	            } else if (state.auth.status == '0001') {
	                //  --------- (废弃)
	                thirdStep();
	            } else if (state.auth.status == '0101') {
	                seconedStep();
	            } else if (state.auth.status == '0102') {
	                thirdStep();
	            } else if (state.auth.status == '02') {
	                // 待激活, 且手机实名认证完成  手机实名认证一共三种状态,未认证,已认证,认证中.
	                if (state.auth.mobileAuthFlag == 'noauth') {
	                    // 再次申请
	                } else if (state.auth.mobileAuthFlag == 'fail') {
	            ...
	            } else if (state.auth.status == '03') {// 征信审核失败
	                // 检查锁单天数, 如果 lockDays <=0, 调用清空用户信息接口, 然后跳转身份认证页
	                //                            >0, 显示剩余天数

	            } else if (state.auth.status == '04') {// 决策进行中??? 带个刷新按钮 --------- (废弃)
	                // 带刷新按钮的页面
	            } else if (state.auth.status == '05') {// 决策异常
	                // 刷新页面, 去掉刷新按钮
	            } else if (state.auth.status == '0501') {// 征信姓名和手机实名认证不匹配 --------- (废弃)
	                // 重新申请网络请求'/customer/recredit', 成功后走授信流程, 显示身份认证页面
	            } else if (state.auth.status == '06') {
	                // 授信流程已经走完

	                // ------------需要重新过一遍
	                if (state.auth.page == '3') {
	                    if (state.auth.ageCondition == '0') {
	                        Vue.TipHelper.showHub('2', '对不起，根据您的信用情况，暂时无法为您提供服务');
	                    } else {
	                        // 显示申请提现页面
	                    }
	                } else if (state.auth.page == '4' || state.auth.page == '5' || state.auth.page == '6' || state.auth.page == '7') {
	                    // 显示提现状态页面
	                } else {
	                        // fail
	                    }
	...
	// 身份认证 - 提交
	function IDENTITY_SAVE(_ref2, payload) {
	    ...
	    var prama = {
	        ...
	        creditApplyType: state.auth.creditApplyType, // 1 - 信息认证;     0 / null - 其他
	        realName: state.auth.realName,
	        educationDegree: state.auth.educationDegree,
	        marryStatus: state.auth.marryStatus,
	        identityNo: state.auth.identityNo
	    };
	...
	// 信息认证初始化
	function INFOAUTH_INIT(_ref3, payload) {
	...
	// 信息认证 - 提交
	function INFOAUTH_SAVE(_ref4, payload) {
	    ...
	    var prama = {
	        ...
	        "x-auth-token": rootState.token,
	        customerId: rootState.customerId,
	        monthlyIncomeCard: state.auth.monthlyIncomeCard,
	        monthlyIncomeCash: state.auth.monthlyIncomeCash,
	        industry: state.auth.industry,
	        profession: state.auth.profession,
	        payFundOrSecurity: state.auth.payFundOrSecurity
	    };
	    ...
	    Vue.HttpHelper.post(Vue.UrlMacro.INFOAUTH_SAVE, prama, function (res) {
	        ...
	        if (res.status == 1) {
	            ...
	            if (res.data.isCreditSwich == 0) {
	                if (state.auth.creditApplyType == 0) {
	                    thirdStep();
	                } else {
	                    thirdStep();
	                }
	...
	// 银行卡认证初始化
	function BANKCARD_INIT(_ref5, payload) {
	...
	// 银行卡认证 - 提交
	function BANKCARD_SAVE(_ref6, payload) {
	    ...
	    var prama = {
	        mobile: state.auth.bankMobile, // 注意, 这里是银行预留电话
	        "x-auth-token": rootState.token,
	        customerId: rootState.customerId,
	        cardType: state.auth.cardType,
	        cardNo: state.auth.cardNo,
	        cardBank: state.auth.cardBank,
	        bankCode: state.auth.bankCode,
	        bankInfoId: state.auth.bankInfoId // 后台自定义字段, 不需要处理, 传''就行
	    };
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _FaceMutations = __webpack_require__(179);

	var mutations = _interopRequireWildcard(_FaceMutations);

	var _FaceActions = __webpack_require__(180);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _LinkManMutations = __webpack_require__(182);

	var mutations = _interopRequireWildcard(_LinkManMutations);

	var _LinkManActions = __webpack_require__(183);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _CommissionMutations = __webpack_require__(185);

	var mutations = _interopRequireWildcard(_CommissionMutations);

	var _CommissionActions = __webpack_require__(186);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _commissionApplyMutations = __webpack_require__(188);

	var mutations = _interopRequireWildcard(_commissionApplyMutations);

	var _commissionApplyActions = __webpack_require__(189);
...
/***/ (function(module, exports) {
	...
	function COMMISSION_INIT_COMMISSIONINFO(state, payload) {
	    ...
	    // state.comsAmt = res.data.comsAmt== null ? '' : res.data.comsAmt;
	...
	function COMMISSION_COMMCASH_INITDATA(state, payload) {
	    ...
	    state.parampressImg = 'WXLocal/bank_logo_dark_' + state.bankCode;
	    state.bankiconImg = 'WXLocal/bank_logo_' + state.bankCode;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _RouterEvent = __webpack_require__(191);

	var _RouterEvent2 = _interopRequireDefault(_RouterEvent);

	var _ParamEvent = __webpack_require__(192);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _UrlMacro = __webpack_require__(194);

	var _UrlMacro2 = _interopRequireDefault(_UrlMacro);

	var _HttpHelper = __webpack_require__(195);

	var _HttpHelper2 = _interopRequireDefault(_HttpHelper);

	var _NaviHelper = __webpack_require__(196);

	var _NaviHelper2 = _interopRequireDefault(_NaviHelper);

	var _LogHelper = __webpack_require__(197);

	var _LogHelper2 = _interopRequireDefault(_LogHelper);

	var _StorageHelper = __webpack_require__(198);

	var _StorageHelper2 = _interopRequireDefault(_StorageHelper);

	var _TipHelper = __webpack_require__(199);
	        ...
	        eventModule.wxEncryptJsonStr(jsonStr, function (r) {
	            ...
	            return stream.fetch({
	                ...
	                if (res.status === 200 && res.ok === true) {
	                    ...
	                    // 请求失败
	                    Vue.TipHelper.dismisHub();
	                    Vue.TipHelper.showHub('1', '网络请求失败');
	                }
	            }, function (progress) {});
	        });
	    }

...
public class ShopHomeCategoryController {
    ...
    public Response indexCategoryInit() {
        try {
            ...
            List<CategoryVo> CategoryVos = categoryInfoService.selectCategoryVoList(Long
                    .parseLong(CategoryLevel.CATEGORY_LEVEL1.getCode()));
    ...
    public Response indexCategoryInitJd() {
        try {
            Map<String, Object> returnMap = new HashMap<String, Object>();
            List<CategoryVo> CategoryVos = categoryInfoService.selectCategoryVoListJd(Long
                    .parseLong(CategoryLevel.CATEGORY_LEVEL1.getCode()));
            returnMap.put("categorys", CategoryVos);
            return Response.successResponse(returnMap);
        } catch (Exception e) {

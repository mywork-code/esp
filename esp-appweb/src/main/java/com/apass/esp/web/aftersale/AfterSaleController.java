...
public class AfterSaleController {
    ...
    public Response returnGoods(Map<String, Object> paramMap) {
        ...
        try {
            ...
            List<GoodsStockIdNumDto> returngoodsList = GsonUtils.convertList(returngoodsInfo,
                    GoodsStockIdNumDto.class);
            ...
            afterSaleService.returnGoods(requestId, userId, orderId, returnPriceVal, operate, reason,
                    content, returngoodsList, imageNumVal);
    ...
    public Response submitLogistics(Map<String, Object> paramMap) {
        ...
        try {
            afterSaleService.submitLogisticsInfo(requestId, userId, refundId, orderId, logisticsName,
                    logisticsNo);
